        ...
        try {
            ...
            list2.forEach(data => {
                d.push({
                    ...
                    desc: data.ck,
                    img: data.tp,
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").baike()',
                    col_type: 'icon_4_card',
                    extra: {
                        host: data.dz,
                        mz: data.mz,
                ...
                if (lx == '二级菜单') {
                    if (wz == 'caoliu' || wz == 'heiliaoshequ') {
                        d.push({
                            ...
                            desc: qb,
                            img: 'http://api.xka1.top' + tp,
                            url: 'hiker://empty?#noHistory#@rule=js:$.require("qiezi").videoerji()',
                            col_type: 'icon_4_card',
                            extra: {
                    ...
                    d.push({
                        ...
                        desc: qb,
                        img: 'http://api.xka1.top' + tp,
                        url: 'hiker://empty?@rule=js:$.require("qiezi").zhiboerji()',
                        col_type: 'icon_4_card',
                        extra: {
                            host: `${ym}/${wz}.php`,
                            wz: wz,
                    ...
                    d.push({
                        ...
                        desc: qb,
                        img: 'http://api.xka1.top' + tp,
                        url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").nvyouerji()',
                        col_type: 'icon_4_card',
                        extra: {
                            host: `${ym}/${wz}.php`,
                            wz: wz,
                    ...
                    d.push({
                        ...
                        desc: qb,
                        img: 'http://api.xka1.top' + tp,
                        url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").tieerji()',
                        col_type: 'icon_4_card',
                        extra: {
                            host: `${ym}/${wz}.php`,
                            wz: wz,
                    ...
                    d.push({
                        ...
                        desc: qb,
                        img: 'http://api.xka1.top' + tp,
                        url: 'hiker://empty@rule=js:$.require("qiezi").zhibojuheerji()',
                        col_type: 'icon_4_card',
                        extra: {
                            wz: mc,
                        }
                    ...
                    if (mc == '猫咪漫画') {
                        d.push({
                            ...
                            desc: qb,
                            img: 'http://api.xka1.top' + tp,
                            url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").maomimanhua()',
                            col_type: 'icon_4_card'
                        })
                    } else {
                        d.push({
                    ...
                    d.push({
                        ...
                        desc: qb,
                        img: 'http://api.xka1.top' + tp,
                        url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").xiaoshuoerji()',
                        col_type: 'icon_4_card',
                        extra: {
                            host: `${ym}/${wz}.php`,
                            wz: wz,
                    ...
                    if (mc == '猫咪美图') {
                        d.push({
                            ...
                            desc: qb,
                            img: 'http://api.xka1.top' + tp,
                            url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").maomimeitu()',
                            col_type: 'icon_4_card'
                        })
                    } else if (mc != '美图色图') {
                        d.push({
                    ...
                    if (mc == '猫咪FM') {
                        d.push({
                            ...
                            desc: qb,
                            img: 'http://api.xka1.top' + tp,
                            url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").maomiFM()',
                            col_type: 'icon_4_card'
                        })
                    }
                }
        ...
        try {
            ...
            if (getMyVar('搜索分类名', '视频') == '视频') {
                ...
                if (wz == 'haijiao') {
                    list.forEach(data => {
                        d.push({
                            ...
                            url: 'hiker://empty@rule=js:$.require("qiezi").blackerji1()',
                            col_type: 'pic_1',
                            extra: {
                ...
                list.forEach(data => {
                    d.push({
                        title: data.title,
                        url: 'hiker://empty?#readTheme#@rule=js:$.require("qiezi").xiaoshuoerji1()',
                        col_type: 'text_1',
                        extra: {
                            host: `${host}?id=${data.id}`,
                            wz: wz,
                ...
                list.forEach(data => {
                    d.push({
                        ...
                        desc: data.date,
                        img: data.image,
                        url: 'hiker://empty@rule=js:$.require("qiezi").manhuaerji1()',
                        col_type: 'movie_3',
                        extra: {
                            host: `${host}?id=${data.id}`,
                            wz: wz,
                ...
                list.forEach(data => {
                    d.push({
                        ...
                        //url:'hiker://empty?page=fypage@rule=js:$.require("qiezi").tupianerji()',
    ...
    videoerji: () => {
        ...
        try {
            ...
            data[getMyVar('视频分类' + wz, key_n)].forEach(data => {
                d.push({
                    title: data.title,
                    url: 'hiker://empty?page=fypage&#noHistory#@rule=js:$.require("qiezi").voderji1()',
                    col_type: 'text_3',
                    extra: {
        ...
        try {
            ...
            data.forEach(data => {
                d.push({
                    ...
                    desc: data.number,
                    img: data.image,
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").nvyouerji1()',
                    col_type: 'card_pic_3',
                    extra: {
                        host: `${host}?sort=${data.id}&page=`,
                        wz: wz,
            ...
            if (list != null) {
                list.forEach(data => {
                    d.push({
                        ...
                        desc: data.date,
                        img: wz == 'tiktok18' ? (data.image + lazy) : data.image,
                        //url: 'hiker://empty?@rule=js:$.require("qiezi").tupianerji()',
                        url: wz == 'tuzac' ? (host + '?id=' + data.id + tuzpics) : (host + '?id=' + data.id + pics),
                        col_type: 'movie_3',
                        extra: {
                            host: `${host}?id=${data.id}`,
            ...
            if (MY_PAGE == 1) {
                ...
                data.forEach(data => {
                    d.push({
                        title: data.title,
                        img: data.image,
                        url: 'hiker://empty?@rule=js:$.require("qiezi").zhiboerji1()',
                        col_type: 'card_pic_3',
                        extra: {
        ...
        if (分类 == 1) {
            ...
            list.forEach((data) => {
                d.push({
                    ...
                    pic_url: data.image,
                    col_type: "icon_3",
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").pindao_91tv()',
                    extra: {
                        id: data.id,
                    }
                })
            ...
            list.forEach((data) => {
                d.push({
                    ...
                    //img:data.thumb+mdlazy,
                    col_type: "text_3",
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").biaoqian_91tv()',
                    extra: {
                        id: data.id,
                    }
                })
    ...
    baike: () => {
        ...
        if (MY_PAGE == 1) {
            d.push({   
                ...
                url: $.toString(() => {
                    putMyVar('keyword', input)
                    return "hiker://empty?page=fypage&kw=" + input + '@rule=js:$.require("qiezi").avbkss()'
                }),
                   desc: "请输入搜索关键词",
                   col_type: "input",
                extra: {
        ...
        try {
            ...
            list.forEach(data => {
                d.push({
                    title: data.title,
                    img: data.thumb,
                    url: 'hiker://empty?page=fypage&#immersiveTheme#@rule=js:$.require("qiezi").maomimanhuaerji()',
    ...
    maomiav: () => {
        ...
        if (MY_PAGE == 1) {
            ...
            child.forEach(data => {
                d.push({
                    title: data.name,
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").maomiav_erji()',
                    col_type: 'text_3',
                    extra: {
                        id: data.id,
                    }
            ...
            if (MY_PAGE == 1) {
                ...
                data.forEach(data => {
                    d.push({
                        ...
                        desc: data.Number,
                        img: data.xinimg,
                        url: 'hiker://empty@rule=js:$.require("qiezi").zhibojuheerji1()',
                        col_type: 'card_pic_3',
                        extra: {
        ...
        if (分类 == 1) {
            ...
            list.forEach((data) => {
                d.push({
                    ...
                    pic_url: data.image,
                    col_type: "icon_3",
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").madoupindao()',
                    extra: {
                        id: data.id,
                    }
                })
            ...
            list.forEach((data) => {
                d.push({
                    ...
                    //pic_url:data.thumb,
                    col_type: "text_3",
                    url: 'hiker://empty?page=fypage@rule=js:$.require("qiezi").madoubiaoqian()',
                    extra: {
                        id: data.id,
                    }
                })
